...
import StatusColumn from './statusUpdate/StatusColumn';
import BankUpdateColumn from './statusUpdate/BankUpdateColumn';
import KycUpdateColumn from './statusUpdate/KycUpdateColumn';
const UserUpdates: React.FC = () => {
  ...
  
  {
    ...
    render: (_text: string, record: User) => <StatusColumn record={record} />,
  }, 
  {
    ...
    render: (bankUpdateRequest: string, record: User) => {
      if (bankUpdateRequest === 'uploadBankDetails') {
        return (
          <span className="space-mono" style={{ color: 'black', fontWeight: 'bold' }}>
        ...
        return (
          <BankUpdateColumn record={record} />
        )
      }
    },
  },  
...
,
{
        ...
        render: (kycVerified: string, record: User) => {
          if (kycVerified === 'verifyKyc') {
            return (
              <span className="space-mono" style={{ color: 'black', fontWeight: 'bold' }}>
                Kyc Details Not Uploaded
              </span>
            );
          }
          else{
            return (
              <KycUpdateColumn record={record} />
            )
          }
        },
    },    
          ...
          <div className="bg-white space-micro p-4 rounded-lg shadow-md">
            {users.map((user) => (
              <div key={user._id} className="recharge-card mb-4">
                ...
                <div><strong>Status:</strong><StatusColumn record={user} /></div>
